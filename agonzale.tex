...
\begin{itemize}
    ...
    \item [Since 2012] Gitolite (GiT) service manager. Closed in favour of Gitlab in July 2017. The service served as an alternative toSubversion when GitLab was not yet ready for production. Based in Puppet VMs and a Perl access control system.
