...
\url{http://alvaroga.name} \\ % Your website
\href{tel:358408127118}{+358 40 81 27 118} \\ % Your phone number
\Sep % Some whitespace
\textbf{Address} \\
Veturikuja 4 E 50 \\ % Address 1
Vantaa, 01300 \\ % Address 2
\Sep
\textbf{Nationality} \\
	Spanish \includegraphics{spain.png}\\ % Nationality
\Sep
\textbf{Languages} \\
\includegraphics{spain.png} Spanish, C2 Native \\ 
\includegraphics{uk.png} English, C1 Fluent \\
\includegraphics{france.png} French, B1 Interm. \\
...
\CVSection{Main technologies I worked with}{
\begin{itemize}
\item Python, Django, Bash
\item Puppet, Kubernetes, Openshift
\item Jira, GIT, GitLab, Subversion, WebSVN, Trac
\item Nginx, Apache, Docker, OAuth, PostgreSQL, Oracle, curl, openssl, TLS, Let's Encrypt, PaaS
\item Centos, Red Hat Enterprise Linux, Scientific Linux, Fedora Atomic, Debian, Ubuntu
\end{itemize}
}
\Sep
\CVSection{Other technologies}{

\begin{itemize}
\item Java, Perl, Javascript, ReactJS
\item Quattor, Ansible, HAProxy
\item Bamboo, Gitlab, CVS, Flexnet, Jenkins
\item SAML, SQLite, Bootstrap
\end{itemize}
}
