...
\CVItem{October 2008 - present, \textit{PJAS, Fellow, and Staff}, CERN}{
	Responsibilities:
\begin{itemize}
	\item Since 2012, JIRA service manager
	\item Since 2012, Gitolite (GIT) service manager
	\item Since 2013, Gitlab
	\item Since 2008, Monitoring
	\item Since 2008, Linux engineering license servers
	\item Since 2009, Subversion service
\end{itemize}
}
